...
export default function AdminEpisodeCreator() {
  ...
  return (
    <div className="min-h-screen bg-kid-page text-white p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Select value={selectedSeries} onValueChange={setSelectedSeries}>
              <SelectTrigger className="bg-kid-surface border-white/10 text-white">
                <SelectValue placeholder="Escolha uma série..." />
              </SelectTrigger>
              <SelectContent className="bg-kid-surface border-white/10">
                {seriesList.map(s => (
          ...
          <div>
            ...
            <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-white/20 rounded-lg cursor-pointer hover:border-kid-accent/50 transition-colors bg-kid-surface">
              {preview ? (
          ...
          <Button
            ...
            className="w-full bg-kid-accent hover:bg-kid-accent-hover text-white font-semibold"
          >
            {loading ? (
