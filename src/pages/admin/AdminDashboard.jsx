...
export default function AdminDashboard() {
  ...
  const { data: series = [] } = useLiveEntityList({ entity: base44.entities.Series });
  const { data: episodes = [] } = useLiveEntityList({ entity: base44.entities.Episode });
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Gerencie todo o conteúdo do KIDSPlay</p>
          </div>
        </div>
