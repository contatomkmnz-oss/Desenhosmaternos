...
export default function AdminMetrics() {
  ...
  return (
    <div className="min-h-screen bg-kid-page pt-20 px-6 pb-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8">Dashboard de Métricas</h1>

        {/* KPI Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-kid-surface rounded-lg p-6 border border-white/5">
          ...
          <div className="bg-kid-surface rounded-lg p-6 border border-white/5">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={metrics.timelineChart}>
                ...
                <Tooltip 
                  contentStyle={{ backgroundColor: '#342e58', border: '1px solid #5b4f8a' }}
                  labelStyle={{ color: '#fff' }}
                />
                <Line type="monotone" dataKey="assinaturas" stroke="#f472b6" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
