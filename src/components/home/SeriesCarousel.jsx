    ...
    >
      ...
      <div className="relative">
        <button
          ...
          aria-label="Anterior"
          onClick={() => scroll('left')}
          className="hidden md:flex absolute left-0 top-0 bottom-0 z-10 w-10 md:w-14 items-center justify-center bg-gradient-to-r from-kid-page to-transparent opacity-0 group-hover/carousel:opacity-100 transition-opacity"
        >
        ...
        <button
          ...
          className="hidden md:flex absolute right-0 top-0 bottom-0 z-10 w-10 md:w-14 items-center justify-center bg-gradient-to-l from-kid-page to-transparent opacity-0 group-hover/carousel:opacity-100 transition-opacity"
        >
