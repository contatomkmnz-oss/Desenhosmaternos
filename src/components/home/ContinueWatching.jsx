    ...
    <div className="mb-8 md:mb-10">
      ...
      <div className="flex gap-2 overflow-x-auto hide-scrollbar px-4 md:px-12 pb-2">
        {items.map(item => (
          ...
          >
            <div className="relative aspect-video rounded-sm overflow-hidden bg-kid-surface">
              {item.episode.thumbnail_url || item.series.cover_url ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-kid-accent/20 to-kid-surface flex items-center justify-center">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gray-600/80">
                <div className="h-full bg-kid-accent" style={{ width: `${item.progress}%` }} />
              </div>
            </div>
