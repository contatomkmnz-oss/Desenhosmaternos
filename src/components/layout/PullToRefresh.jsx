  ...
  return (
    ...
    >
      ...
      {showIndicator && (
        ...
        >
          <div className={`w-8 h-8 rounded-full bg-kid-surface border border-white/10 flex items-center justify-center shadow-lg`}>
            <RefreshCw
              className={`w-4 h-4 text-kid-accent transition-transform ${refreshing ? 'animate-spin' : ''}`}
